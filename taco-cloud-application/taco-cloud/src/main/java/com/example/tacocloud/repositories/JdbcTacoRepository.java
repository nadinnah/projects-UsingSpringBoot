...
public class JdbcTacoRepository implements TacoRepository{
    ...
    public Taco save(Taco taco) {
        ...
        taco.setId(tacoId);
        for(Ingredient ingredient: taco.getIngredients()){ //this works like a foreach
    ...
    private void saveIngredientsToTaco(Ingredient ingredient,long tacoId){
        jdbc.update("insert into Taco_Ingredients(taco, ingredients) "+ "values(?,?)", tacoId,ingredient.getId());
    }
}
